...
In this course, we explore the research-driven Autogen framework and the production ready Agent framework from Semantic Kernel.

In Lesson 2, discover the differences between these AI Agent frameworks and tools.
