...
- ### **[Azure AI Agent Service](https://learn.microsoft.com/azure/ai-services/agents/overview)**
  ...
  - 事前構築されたツール – Bing、Azure AI Search、Azure Functionsなどのデータソースとやり取りするためのツールを使用可能。
    ...
    ![Agentic Service In Action](../../../translated_images/agent-service-in-action.8c2d8aa8e9d91feeb29549b3fde529f8332b243875154d03907616a69198afbc.ja.jpg?WT.mc_id=academic-105485-koreyst)
